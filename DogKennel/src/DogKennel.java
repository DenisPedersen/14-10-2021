...
public class DogKennel {
    public static void main(String[] args) {
        Owner thobias = new Owner("Thobias");
       Dog fido = new Dog("Fido", thobias, true);
        System.out.println("My dog is called " + fido.getName() + " the owner is the lovely " + fido.getOwner().getName());
        ArrayList <Dog> puppies = fido.getOffspring();
        for (Dog newdog : puppies) {
            System.out.println("my dog just got a lot of puppies, they are called " + puppies);
        }
        fido.feedDog();
    }
